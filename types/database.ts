...
export type Database = {
  public: {
    Tables: {
      ...
      selection_panel: {
        Row: { year: number; data: Json; updated_at: string }
        Insert: { year: number; data?: Json; updated_at?: string }
      ...
      allocation: {
        Row: { year: number; teacher_id: string; data: Json; updated_at: string }
        Insert: { year: number; teacher_id: string; data?: Json; updated_at?: string }
      ...
      schedule_plan_version: {
        ...
        Update: Partial<Database['public']['Tables']['schedule_plan_version']['Insert']>
        Relationships: []
      }
      schedule_homeroom: {
      ...
      equipment: {
        Row: {
          ...
          status: string; notes: string; sort_order: number; group_id: string | null
      ...
      equipment_groups: {
        Row: {
          ...
          borrow_checklist: Json; return_checklist: Json
        ...
        Update: Partial<Database['public']['Tables']['equipment_groups']['Insert']>
        Relationships: []
      }
      equipment_config: {
      ...
      equipment_long_loans: {
        Row: {
          id: string; equipment_id: string | null; group_id: string | null
          teacher_id: string | null; external_name: string
