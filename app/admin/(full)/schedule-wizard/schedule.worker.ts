  ...
  return {
    ...
    weights: {
      builtin: {
        ...
        compact: 'off', subjectSpread: 'off', classCohesion: 'off', batchType: 'off',
        dayBalance: { ...b.dayBalance, level: 'off' },
        hourlyBalance: { ...b.hourlyBalance, level: 'off' },
        homeroomBalance: { ...b.homeroomBalance, level: 'off' },
        walkCost: 'off', roomPrefer: 'off', roomManagerFirst: 'off', homeroomMorning: 'off',
