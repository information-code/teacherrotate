...
export interface BuiltinRules {
  ...
  roomHalfDay: WeightLevel                        // 專科教室老師集中：每位老師在同一間專科教室的課集中在少數幾天（一天一位老師，不用每天收器材）；
                                                  //   排不滿一天時剩下那天上午／下午各一位（翁1-4／陳5-6 ✓）；走了不回頭（翁1-2／陳3-4／翁5-6 ✗，自然＝硬限制）。
                                                  //   同一天每多一位老師扣 1、回頭扣 1、半天兩位扣 ½。114-1 人工自然教室：每位老師 3 天、每間只 1 天兩位老師
