...
export const PRINCIPLE_ORDER = ['國語', '數學', '班級活動', '自主學習']
//   選填配課＝必修但非原則、非科任專長（由導師授課）。生活僅低年級出現。
//   順序＝顯示／自動配課的填入順序：生活（低年級主科）優先，再來健康、綜合。
export const OPTIONAL_SUBJECTS = ['生活', '健康', '綜合']
...
// 專案減課常用名稱（下拉快選用；清單外可自行輸入）。地方輔導團各分團 + 常見職務。
export const PROJECT_PRESETS = [
  '語文領域_國語文分團', '語文領域_英語文分團', '語文領域_本土語文分團', '新住民語文輔導團',
  '數學領域分團', '自然科學領域分團', '社會領域分團',
  '藝術領域分團', '綜合活動領域分團', '健康與體育領域分團',
  '生活課程領域分團', '科技領域分團', '特殊教育分團',
  '中央輔導團', '學年主任', '基地班',
]
...
export interface TeacherAllocation {
  ...
  noOvertimeAck?: Record<string, boolean>      // 實際節數 → 已確認「合計＝最低、無意願超鐘」
